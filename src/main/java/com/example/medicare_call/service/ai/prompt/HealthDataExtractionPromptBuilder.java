...
@Component
public class HealthDataExtractionPromptBuilder implements PromptBuilder<HealthDataExtractionRequest> {

    private final String HEALTH_DATA_EXTRACTION_TEMPLATE = """
    ...
    private final String JSON_STRUCTURE_EXAMPLE = """
    ...
    public String buildPrompt(HealthDataExtractionRequest request) {
        ...
        String generatedPrompt = promptTemplate.create().getContents();
